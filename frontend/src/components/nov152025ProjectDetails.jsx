...
return (
  <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
         ...
         <div className="text-right flex justify-end gap-3 mb-4">
           <button 
            onClick={handleBack}
         ...
         {message && (
        <div className="success-message flex justify-center text-center">
          {message}
        </div>
      )}
       {/*Progress Bar*/}
...
{/*<div id="information" className="section-container">
  ...
  <div className="section-header">
    <h2 className="section-title text-2xl font-bold uppercase">{project.name}</h2>
    <h3 className="section-title text-align-left text-2xl font-bold uppercase">{details.project_handiled_by}</h3>
 <h3 className="section-title text-align-left text-2xl font-bold uppercase">{details.event_date}</h3>
    <button
...
<div id="information" className="section-container">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    {/* LEFT BLOCK */}
    <div>
      <h2 className="text-2xl font-bold uppercase text-left">{project.name}</h2>
 {/* small gap */}
      <div className="mt-3"></div>
       {/* HANDLED BY + DATE CENTERED ON SAME LINE */}
      <div className="flex items-center justify-between pr-6">
       <h3 className="text-xl font-semibold uppercase">
          {details.project_handiled_by}
        </h3>
    ...
    <div className="flex flex-col items-end">
      ...
      <img
        ...
        alt={project.name}
        className="w-[220px] h-[190px] object-cover rounded-md border border-gray-300 shadow-sm"
        onError={(e) => (e.target.style.display = "none")}
      />
    )}
     <div className="mt-4"></div>     
    ...
    {mainInvites.map((invite, index) => {
      ...
      return (
        ...
        >
          ...
          {/* Fields */}
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_repeat(4,1fr)_auto] gap-4 items-center">
            <input
              type="date"
