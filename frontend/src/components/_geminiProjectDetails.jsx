  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm relative">
        ...
        <header className="px-8 min-h-[115px] border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-10 w-full">
            ...
            <nav className="hidden md:flex items-center gap-8 font-sans font-bold text-xl text-gray-800 ml-[180px] mt-[42px]">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 top-full mt-2 w-64 bg-white border border-gray-200 rounded shadow-lg opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity z-50">
        ...
        <div className="flex items-start gap-0 relative" >
          ...
          <aside className={`
              ...
              overflow-y-auto
              z-50
              `} style={{ backgroundColor: "#70AD47", minHeight: "100vh", fontWeight: 700, fontSize: "15.5px", top: 0 }}>
            ...
            <div className="flex flex-col h-full w-full">
              ...
              <nav className="flex flex-col pl-[15px] pr-4 py-6 space-y-2">
                <a href="#associate" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">ASSOCIATE</a>
                <a href="#venue" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">VENUE</a>
                <a href="#database" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">DATABASE</a>
                <a href="#rsvp" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">RSVP</a>
                <a href="#av" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">HOTEL AV</a>
                <a href="#av_supplier" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left ftext-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">AV SUPPLIER</a>
                <a href="#embassy" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">EMBASSY / CONSULATE</a>
                <a href="#client" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">CLIENT</a>
                <a href="#stark" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">STARK</a>
                <a href="#checklist" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">CHECKLIST</a>
                <a href="#menu" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">MENU (IMAGE UPLOAD)</a>
                <a href="#remarks" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">REMARKS</a>
                <a href="#print" onClick={() => setIsSidebarOpen(false)} className="hover:opacity-90 text-left text-white text-xl text-left font-sans font-bold uppercase tracking-wide py-2">PRINT</a>
              </nav>
          ...
          <div className="flex-1 overflow-x-hidden">
            ...
            <main className="px-0" >
              ...
              {/* ===================== */}
              <section id="associate" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[600px]">
                    <div className="grid grid-cols-[2fr_1fr_1fr_60px] gap-3 mb-3 p-3 bg-gray-100 rounded font-semibold">
                    ...
                    {associates.map((associate, index) => (
                      <div key={index} className="grid grid-cols-[2fr_1fr_1fr_60px] gap-3 mb-3 p-3 bg-gray-50 rounded items-center">
                        <input
                          type="text"
                          placeholder="Name"
                ...
                <div className="text-center">
                  <button onClick={() => setAssociates([...associates, { name: "", city: "", selected: false }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Associate</button>
                </div>
              </section>
              ...
              <section id="venue" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[1000px]">
                    <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_auto] gap-3 items-center mb-3 p-3 bg-gray-100 rounded font-semibold">
                      <div>Venue Name</div>
                      <div>Currency</div>
                    ...
                    {venues.map((v, i) => (
                      <div key={i} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_auto] gap-3 items-center mb-3 p-3 bg-gray-50 rounded">
                        <input type="text" value={v.name} onChange={(e) => {
                          const arr = [...venues]; arr[i].name = e.target.value; setVenues(arr);
                        }} className="px-3 py-2 border rounded w-full" placeholder="Venue Name" />

                        <select value={v.currency} onChange={(e) => {
                          const arr = [...venues]; arr[i].currency = e.target.value; setVenues(arr);
                        }} className="px-3 py-2 border rounded bg-white w-full">
                        ...
                        }} className="px-3 py-2 border rounded text-right w-full" placeholder="Rate" />
                        ...
                        }} className="px-3 py-2 border rounded text-right w-full" placeholder="Budget" />

                        {/* Checkboxes */}
                        <div className="flex justify-center"><input type="checkbox" checked={v.venue_rental} onChange={(e) => { const arr = [...venues]; arr[i].venue_rental = e.target.checked; setVenues(arr); }} className="w-3.5 h-3.5 accent-green-600" /></div>
                        <div className="flex justify-center"><input type="checkbox" checked={v.av} onChange={(e) => { const arr = [...venues]; arr[i].av = e.target.checked; setVenues(arr); }} className="w-3.5 h-3.5 accent-green-600" /></div>
                        <div className="flex justify-center"><input type="checkbox" checked={v.food} onChange={(e) => { const arr = [...venues]; arr[i].food = e.target.checked; setVenues(arr); }} className="w-3.5 h-3.5 accent-green-600" /></div>
                        <div className="flex justify-center"><input type="checkbox" checked={v.bar} onChange={(e) => { const arr = [...venues]; arr[i].bar = e.target.checked; setVenues(arr); }} className="w-3.5 h-3.5 accent-green-600" /></div>
                        <div className="flex justify-center"><input type="checkbox" checked={v.selected} onChange={(e) => { const arr = [...venues]; arr[i].selected = e.target.checked; setVenues(arr); }} className="w-3.5 h-3.5" /></div>

                        <div className="flex justify-end">
                          {venues.length > 1 && <button onClick={() => setVenues(venues.filter((_, j) => j !== i))} className="text-red-600">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg>
                          </button>}
                        </div>
                      </div>
                    ))}
                ...
                <div className="text-center">
                  <button onClick={() => setVenues([...venues, { name: "", currency: "INR", rate: "", rateInput: "", budget: "", budgetInput: "", selected: false, venue_rental: false, av: false, food: false, bar: false }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Venue</button>
                </div>
              </section>
              ...
              <section id="database" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    {tradeDatabase.map((trade, index) => {
                      ...
                      return (
                        <div key={index} className="grid grid-cols-[2fr_repeat(5,1fr)_auto] gap-3 items-center mb-3 p-3 bg-gray-50 rounded">
                          <input type="text" placeholder="Category Name" value={trade.trade_name} onChange={(e) => handleTradeChange(index, "trade_name", e.target.value)} className="form-input w-full" />
                          <input type="number" value={trade.travel_operator} onChange={(e) => handleTradeChange(index, "travel_operator", e.target.value)} className="form-input text-right w-full" />
                          <input type="number" value={trade.travel_agent} onChange={(e) => handleTradeChange(index, "travel_agent", e.target.value)} className="form-input text-right w-full" />
                          <input type="number" value={trade.travel_counsellor} onChange={(e) => handleTradeChange(index, "travel_counsellor", e.target.value)} className="form-input text-right w-full" />
                          <input type="number" value={trade.media_influencers} onChange={(e) => handleTradeChange(index, "media_influencers", e.target.value)} className="form-input text-right w-full" />
                          <div className="font-semibold text-center">{categoryTotal}</div>
                          <div className="flex justify-end">
                            {tradeDatabase.length > 1 && <button onClick={() => handleRemoveTrade(index)} className="text-red-600"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg></button>}
                          </div>
                        </div>
                      );
                    })}
                ...
                <button type="button" onClick={handleAddTrade} className="mt-4 px-5 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-800 transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">+ Add Trade</button>
              </section>

              {/* RSVP / Save The Date & Main Invites */}
              <section id="rsvp" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="bg-white shadow-sm rounded-lg p-4 border border-blue-50 mb-4">
                  ...
                  <div className="overflow-x-auto">
                    <div className="min-w-[700px]">
                      <div className="grid grid-cols-[1.5fr_repeat(5,1fr)] gap-4 items-end mb-4 bg-gray-100 p-2 rounded font-semibold text-sm">
                        <div>Date</div>
                      ...
                      <div className="grid grid-cols-[1.5fr_repeat(5,1fr)] gap-3 items-end mb-4">
                        <input type="date" value={saveDate.save_the_date || ""} onChange={(e) => setSaveDate({ ...saveDate, save_the_date: e.target.value })} className="form-input w-full" />
                        <input type="number" className="form-input text-right w-full" value={saveDate.save_the_date_to_nos || ""} onChange={(e) => setSaveDate({ ...saveDate, save_the_date_to_nos: e.target.value })} placeholder="Tour Operator" />
                        <input type="number" className="form-input text-right w-full" value={saveDate.save_the_date_ta_nos || ""} onChange={(e) => setSaveDate({ ...saveDate, save_the_date_ta_nos: e.target.value })} placeholder="Travel Agent" />
                        <input type="number" className="form-input text-right w-full" value={saveDate.save_the_date_travel_counsellors_nos || ""} onChange={(e) => setSaveDate({ ...saveDate, save_the_date_travel_counsellors_nos: e.target.value })} placeholder="Travel Counsellors" />
                        <input type="number" className="form-input text-right w-full" value={saveDate.save_the_date_influencers_nos || ""} onChange={(e) => setSaveDate({ ...saveDate, save_the_date_influencers_nos: e.target.value })} placeholder="Media / Influence" />
                ...
                <div className="bg-white rounded-lg p-4 border border-purple-100 shadow-sm">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="file" onChange={(e) => setMainInviteImage(e.target.files[0])} className="form-input" />
                    {mainInviteImage && (
                      <div className="flex items-center gap-3 mt-2">
                        <img src={mainInviteImage instanceof File ? URL.createObjectURL(mainInviteImage) : mainInviteImage} alt="Main Invite" className="w-24 h-16 object-cover rounded border" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="overflow-x-auto">
                    <div className="min-w-[800px]">
                      <div className="grid grid-cols-[320px_200px_200px_200px_200px_170px_minmax(100px,1fr)] gap-2 items-center bg-gray-100 p-2 rounded font-semibold">
                        <div>Date</div>
                      ...
                      {mainInvites.map((inv, idx) => {
                        ...
                        return (
                          <div key={idx} className="bg-gray-50 p-3 rounded-md mb-3">
                            ...
                            <div className="grid grid-cols-[320px_200px_200px_200px_200px_170px_minmax(100px,1fr)] gap-2 items-center">
                              <input type="date" className="form-input w-full" value={inv.main_invite_date || ""} onChange={(e) => { const arr = [...mainInvites]; arr[idx].main_invite_date = e.target.value; setMainInvites(arr); }} />
                              <input type="number" className="form-input text-right w-full" value={inv.main_invite_to_nos || ""} onChange={(e) => { const arr = [...mainInvites]; arr[idx].main_invite_to_nos = e.target.value; setMainInvites(arr); }} />
                              <input type="number" className="form-input text-right w-full" value={inv.main_invite_ta_nos || ""} onChange={(e) => { const arr = [...mainInvites]; arr[idx].main_invite_ta_nos = e.target.value; setMainInvites(arr); }} />
                              <input type="number" className="form-input text-right w-full" value={inv.main_invite_travel_counsellors_nos || ""} onChange={(e) => { const arr = [...mainInvites]; arr[idx].main_invite_travel_counsellors_nos = e.target.value; setMainInvites(arr); }} />
                              <input type="number" className="form-input text-right w-full" value={inv.main_invite_influencers_nos || ""} onChange={(e) => { const arr = [...mainInvites]; arr[idx].main_invite_influencers_nos = e.target.value; setMainInvites(arr); }} />
                              <div className="text-center font-semibold bg-gray-100 rounded-md py-2">{rowTotal}</div>
                              <div className="flex justify-end"><button onClick={() => setMainInvites(mainInvites.filter((_, x) => x !== idx))} className="text-red-600"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg></button></div>
                            </div>
                          </div>
                        );
                      })}

                      <div className="grid grid-cols-[320px_210px_210px_210px_210px_170px] gap-2 items-center mt-4 p-3 bg-gray-100 rounded font-semibold">
                        <div>Total →</div>
                  ...
                  <div className="text-center mt-3">
                    <button onClick={() => setMainInvites([...mainInvites, { main_invite_date: "", main_invite_to_nos: 0, main_invite_ta_nos: 0, main_invite_travel_counsellors_nos: 0, main_invite_influencers_nos: 0 }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Main Invitation Date</button>
                  </div>
                </div>
              </section>
              ...
              <section id="av" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button onClick={saveAVSetup} disabled={saving === "av"} className={`px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 ${saving === "av" ? "opacity-50 cursor-not-allowed" : ""}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div><label className="block mb-1 font-medium">Backdrop (Specs)</label><input type="text" value={avSetup.backdrop || ""} onChange={(e) => setAvSetup({ ...avSetup, backdrop: e.target.value })} className="form-input w-full" /></div>
                    <div><label className="block mb-1 font-medium">Screen (Specs)</label><input type="text" value={avSetup.screen || ""} onChange={(e) => setAvSetup({ ...avSetup, screen: e.target.value })} className="form-input w-full" /></div>
                    <div><label className="block mb-1 font-medium">Mic (Nos)</label><input type="number" value={avSetup.mic || ""} onChange={(e) => setAvSetup({ ...avSetup, mic: e.target.value })} className="form-input w-full" /></div>
                    <div><label className="block mb-1 font-medium">Type (System)</label><input type="text" value={avSetup.type || ""} onChange={(e) => setAvSetup({ ...avSetup, type: e.target.value })} className="form-input w-full" /></div>
                    <div className="flex gap-6 mt-3">
                      <label className="flex items-center gap-2"><input type="checkbox" checked={avSetup.projector || false} onChange={(e) => setAvSetup({ ...avSetup, projector: e.target.checked })} className="w-3.5 h-3.5 accent-green-600" /> Projector</label>
                      <label className="flex items-center gap-2"><input type="checkbox" checked={avSetup.podium || false} onChange={(e) => setAvSetup({ ...avSetup, podium: e.target.checked })} className="w-3.5 h-3.5 accent-green-600" /> Podium</label>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <div><label className="block mb-1 font-medium">Backdrop Image</label><input type="file" accept=".jpg,.jpeg,.png" onChange={(e) => setAvSetup({ ...avSetup, backdrop_image: e.target.files[0] })} className="form-input" />{avSetup.backdrop_image && (<img src={avSetup.backdrop_image instanceof File ? URL.createObjectURL(avSetup.backdrop_image) : avSetup.backdrop_image} className="h-24 mt-2 rounded shadow" />)}</div>
                    <div><label className="block mb-1 font-medium">Screen Image</label><input type="file" accept=".jpg,.jpeg,.png" onChange={(e) => setAvSetup({ ...avSetup, screen_image: e.target.files[0] })} className="form-input" />{avSetup.screen_image && (<img src={avSetup.screen_image instanceof File ? URL.createObjectURL(avSetup.screen_image) : avSetup.screen_image} className="h-24 mt-2 rounded shadow" />)}</div>
                    <div><label className="block mb-1 font-medium">Stage Image</label><input type="file" accept=".jpg,.jpeg,.png" onChange={(e) => setAvSetup({ ...avSetup, stage_image: e.target.files[0] })} className="form-input" />{avSetup.stage_image && (<img src={avSetup.stage_image instanceof File ? URL.createObjectURL(avSetup.stage_image) : avSetup.stage_image} className="h-24 mt-2 rounded shadow" />)}</div>
                  </div>
                </div>
              </section>
              ...
              <section id="av_supplier" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[600px]">
                    ...
                    {hotels.map((h, i) => (
                      <div key={i} className="grid grid-cols-[2fr_1.5fr_1fr_1fr_1fr_auto] gap-3 items-center mb-3 p-3 bg-gray-50 rounded">
                        <input value={h.sponsor || ""} onChange={(e) => { const arr = [...hotels]; arr[i].sponsor = e.target.value; setHotels(arr); }} className="px-3 py-2 border rounded w-full" placeholder="Supplier Name" />
                        <input value={h.item || ""} onChange={(e) => { const arr = [...hotels]; arr[i].item = e.target.value; setHotels(arr); }} className="px-3 py-2 border rounded w-full" placeholder="Item" />
                        ...
                        <input value={h.amount || ""} onChange={(e) => { const arr = [...hotels]; arr[i].amount = e.target.value; setHotels(arr); }} className="px-3 py-2 border rounded text-right w-full" placeholder="Amount" />
                        ...
                        <div>{hotels.length > 1 && <button onClick={() => setHotels(hotels.filter((_, idx) => idx !== i))} className="text-red-600"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg></button>}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button onClick={() => setHotels([...hotels, { sponsor: "", item: "", currency: "INR", amount: "" }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Supplier</button>
                </div>
              </section>
              ...
              <section id="embassy" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button onClick={saveEmbassy} disabled={saving === "embassy"} className={`px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 ${saving === "embassy" ? "opacity-50 cursor-not-allowed" : ""}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 rounded p-4 mb-6">
                  <input type="text" placeholder="Name" value={embassy.cheif_guest} onChange={(e) => setEmbassy({ ...embassy, cheif_guest: e.target.value })} className="form-input w-full" />
                  <input type="text" placeholder="Designation" value={embassy.cheif_guest_designation} onChange={(e) => setEmbassy({ ...embassy, cheif_guest_designation: e.target.value })} className="form-input w-full" />
                  <input type="text" placeholder="Phone" value={embassy.cheif_guest_phone} onChange={(e) => setEmbassy({ ...embassy, cheif_guest_phone: e.target.value })} className="form-input w-full" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 rounded p-4">
                  <input type="text" placeholder="Contact Name" value={embassy.accommodation_contact} onChange={(e) => setEmbassy({ ...embassy, accommodation_contact: e.target.value })} className="form-input w-full" />
                  <input type="text" placeholder="Address" value={embassy.accommodation_address} onChange={(e) => setEmbassy({ ...embassy, accommodation_address: e.target.value })} className="form-input w-full" />
                  <input type="text" placeholder="Phone" value={embassy.accommodation_phone} onChange={(e) => setEmbassy({ ...embassy, accommodation_phone: e.target.value })} className="form-input w-full" />
                </div>
              </section>
              ...
              <section id="client" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="font-sans font-extrabold uppercase text-2xl tracking-wide">CLIENT</h2>
                  <button onClick={async () => {
                    setSaving("clients");
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[600px]">
                    ...
                    {Array.isArray(clients) && clients.map((c, i) => (
                      <div key={i} className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-3 items-center mb-3 p-3 bg-gray-50 rounded">
                        <input className="px-2 py-2 border rounded w-full" value={c.name || ""} onChange={(e) => { const arr = [...clients]; arr[i].name = e.target.value; setClients(arr); }} />
                        <input className="px-2 py-2 border rounded w-full" value={c.designation || ""} onChange={(e) => { const arr = [...clients]; arr[i].designation = e.target.value; setClients(arr); }} />
                        <input className="px-2 py-2 border rounded w-full" value={c.contact || ""} onChange={(e) => { const arr = [...clients]; arr[i].contact = e.target.value; setClients(arr); }} />
                        <input className="px-2 py-2 border rounded w-full" value={c.hotel || ""} onChange={(e) => { const arr = [...clients]; arr[i].hotel = e.target.value; setClients(arr); }} />
                        <div>{clients.length > 1 && <button onClick={() => setClients(clients.filter((_, idx) => idx !== i))} className="text-red-600"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg></button>}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button onClick={() => setClients([...clients, { name: "", designation: "", contact: "", hotel: "" }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Client</button>
                </div>
              </section>
              ...
              <section id="stark" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[400px]">
                    ...
                    {Array.isArray(starks) && starks.map((s, i) => (
                      <div key={i} className="grid grid-cols-[2fr_1fr_auto] gap-3 items-center mb-3 p-3 bg-gray-50 rounded">
                        <input className="px-2 py-2 border rounded w-full" value={s.name || ""} onChange={(e) => { const arr = [...starks]; arr[i].name = e.target.value; setStarks(arr); }} />
                        <input className="px-2 py-2 border rounded w-full" value={s.hotel || ""} onChange={(e) => { const arr = [...starks]; arr[i].hotel = e.target.value; setStarks(arr); }} />
                        <div>{starks.length > 1 && <button onClick={() => setStarks(starks.filter((_, idx) => idx !== i))} className="text-red-600"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3V4H4V6H5V19C5 20.1 5.9 21 7 21H17C18.1 21 19 20.1 19 19V6H20V4H15V3H9ZM7 6H17V19H7V6Z" /><path d="M9 8H11V17H9V8ZM13 8H15V17H13V8Z" /></svg></button>}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button onClick={() => setStarks([...starks, { name: "", hotel: "" }])} className="mt-4 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 hover:shadow-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Add New Stark</button>
                </div>
              </section>
              ...
              <section id="checklist" className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="flex justify-between items-center mb-4 ">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 ${saving === "checklists" ? "opacity-50 cursor-not-allowed" : ""
                      }`}
                  >
