        ...
        <div className="w-full mt-8 flex px-10 gap-6">
          ...
          <div className="w-full space-y-10">
            ...
            <div id="information" className="w-full">
              ...
              {/* LINE 5 — 3-COLUMN LAYOUT */}
            <div className="grid grid-cols-3 w-full items-center">
              <div className="text-left font-bold">
               <span className='font-bold uppercase'>{details.project_handiled_by}</span></div>
            ...
            {/* ASSOCIATES */}
            <div id="associate">
              <h3 className="text-lg font-semibold mb-3 text-left">ASSOCIATES</h3>
            ...
            <div id="venue">
              <h3 className="text-lg font-semibold mb-3 text-left">VENUES</h3>
            ...
            {/* DATABASE */}
            <div id="database">
              <h3 className="text-lg font-semibold mb-3 text-left">DATABASE</h3>
...
{/* 🌟 GRAND TOTAL ROW */}
    {(() => {
      ...
      return (
        <div className="grid grid-cols-[2fr_repeat(5,1fr)] p-3 mt-2 bg-gray-200 font-semibold rounded">
          <div className="text-center">TOTAL</div>
          ...
          <div className="text-center">{grandTotal}</div>
        </div>
      );
    })()}
            </div>
...
{details.rsvp?.length > 0 && (
  <div id="rsvp">
    <h3 className="text-lg font-semibold mb-3 text-left">RSVP #1 SAVE THE DATE</h3>
...
{details.mainInvites?.length > 0 && (
  <div id="maininvite">
    <h3 className="text-lg font-semibold mb-3 text-left">RSVP #2 MAIN INVITE</h3>

    <div className="grid grid-cols-[2fr_repeat(6,1fr)] bg-gray-200 p-3 font-semibold rounded">
      <div>Date</div>
     <div className="text-center">Tour Operator</div>
      <div className="text-center">Travel Agent</div>
      <div className="text-center">Travel Counsellor</div>
    ...
    {details.mainInvites.map((m, i) => {
      ...
      <div
        ...
        className="mb-2"
      >
          <h3 className="font-semibold text-left mb-2">RSVP #{i + 2} – Main Invite</h3>
          <div className="grid grid-cols-[2fr_repeat(6,1fr)] p-3 border-b bg-gray-50">
        <div className='text-center'> {m.main_invite_date || "-"}</div>
...
{/* 🌟 GRAND TOTAL ROW */}
    {(() => {
      ...
      return (
        <div className="grid grid-cols-[2fr_repeat(6,1fr)] p-3 mt-2 bg-gray-200 font-semibold rounded">
          <div className="text-center">TOTAL</div>
          <div className="text-center">{totalTO}</div>
          <div className="text-center">{totalTA}</div>
          <div className="text-center">{totalTC}</div>
...
{details.av_setup && (
  <div id="av">
    <h3 className="text-lg font-semibold mb-3 text-left">HOTEL AV SETUP</h3>
...
{/* =======================  AV SUPPLIER  ======================= */}
<div id="avsupplier">
  <h3 className="text-lg font-semibold mb-3 text-left">AV SUPPLIER</h3>
  ...
  {details.hotels?.length > 0 ? (
    ...
    <p className="text-gray-500">No AV Supplier data</p>
          ...
          {/* Embassy Section */}
          <div id="embassy" >
            <h3 className="text-lg font-semibold  mb-3 text-left">EMBASSY/CONSULATE</h3>
...
<div id="client" className="mb-6">
  <h3 className="text-lg font-semibold text-slate-800 mb-3 text-left">CLIENT</h3>
...
<div id="stark" className="mb-6">
  <h3 className="text-lg font-semibold text-slate-800 mb-3 text-left">STARK</h3>
  ...
  {/* Menu */}
          <div id='menu' className="mb-6 hidden">
